...
public class SeedData : ItemData
{
    ...
    public SeedData(int itemID, string itemName, string itemDescription, string itemPath, string itemType, int maxNum, int growTime,string seedTilePath,string cropTilePath) : base(itemID, itemName, itemDescription, itemPath, itemType, maxNum)
    {
        this.itemID = itemID;
